...
class Employee:
    ...
    def __str__(self):
        return (
            f"{self.first_name} {self.last_name}, from {self.city} ({self.zip_code}), "
            f"{self.street} and born on {self.birth_date}. "
            f"Hired on {self.hire_date}. Phone num is {self.phone}"
        )
