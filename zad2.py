class Library:
    ...
    def __str__(self):
        return f"library, which located in {self.city} (zip code - {self.zip_code}), at {self.street}. Library is open {self.open_hours}, and the contact number is {self.phone}"
...
class Employee:
    ...
    def __str__(self):
        return f"{self.first_name} {self.last_name}, from {self.city} ({self.zip_code}), {self.street} and born on {self.birth_date}. Hired on {self.hire_date}. Phone num is {self.phone}"
...
class Book:
    ...
    def __str__(self):
        return f"{self.author_name} {self.author_surname} book from {self.publication_date} and with {self.number_of_pages} pages. It's in {self.library}"
